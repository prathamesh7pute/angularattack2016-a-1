...
* `git clone git@github.com:rumblex/angularattack2016-a-1.git`

* `cd angularattack2016-a-1`
...
If you receive an error message `"You do not have permission to publish to a-1.2016.angularattack.io"`, it might mean another team member has already deployed your project to Surge. Ask them to run the next step to give you access.

### Step 3) Add Your Team Members to Surge

* `surge . --add punam.mahale@gmail.com,barun.prasad@hotmail.com,ashutosh.chaturvedi88@gmail.com,prathamesh.satpute@gmail.com`
